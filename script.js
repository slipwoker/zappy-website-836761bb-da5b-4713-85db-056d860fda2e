document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      var e=document.querySelectorAll('a[href^="tel:"]');var n=e.length>0?e[0].getAttribute("href").replace("tel:",""):"0398866776";window.location.href="tel:"+n
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מרכז הטניס הישראלי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://qaapi.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '836761bb-da5b-4713-85db-056d860fda2e',
                    name: data.name || '',
                    email: data.email || '',
